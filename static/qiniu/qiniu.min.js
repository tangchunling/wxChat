function QiniuJsSDK() {
	...
	this.uploader = function(b) {
		...
		var c = {},
			d = b.init && b.init.Error,
			e = b.init && b.init.FileUploaded;
		b.init.Error = function() {}, b.init.FileUploaded = function() {}, a.uptoken_url = b.uptoken_url, a.token = "", a.key_handler = "function" == typeof b.init.Key ? b.init.Key : "", this.domain = b.domain;
		var f = "",
			g = {
				isResumeUpload: !1,
				resumeFilesize: 0,
		...
		h();
		var i = function() {
				if(b.uptoken) a.token = b.uptoken;
				else {
					var c = a.createAjax();
			...
			j = function(c, d, e) {
				var f = "",
					g = !1;
				if(!b.save_key)
					if(g = c.getOption && c.getOption("unique_names"), g = g || c.settings && c.settings.unique_names) {
		...
		return k.bind("Init", function() {
			...
			var e = function(c, d, e) {
					...
					if(void 0 !== h && "object" == typeof h)
						for(var i in h) h.hasOwnProperty(i) && ("function" == typeof h[i] ? f["x:" + i] = h[i](c, d) : "object" != typeof h[i] && (f["x:" + i] = h[i]));
					c.setOption({
						url: "http://upload.qiniu.com/",
						multipart: !0,
						chunk_size: void 0,
			...
			if(h = h || c.settings && c.settings.chunk_size, "html5" === k.runtime && h)
				if(d.size < h) e(c, d, a.key_handler);
				else {
					var i = localStorage.getItem(d.name),
						l = h;
					if(i) {
						i = JSON.parse(i);
						var m = (new Date).getTime(),
							n = i.time || 0,
							o = 864e5;
						o > m - n && 100 !== i.percent && d.size === i.total ? (d.percent = i.percent, d.loaded = i.offset, f = i.ctx, g.isResumeUpload = !0, g.resumeFilesize = i.offset, i.offset + l > d.size && (l = d.size - i.offset)) : localStorage.removeItem(d.name)
					}
					g.startTime = (new Date).getTime(), c.setOption({
						url: "http://upload.qiniu.com/mkblk/" + l,
						multipart: !1,
						chunk_size: h,
			...
			var c = g.currentTime - g.startTime,
				d = b.loaded || 0;
			...
			f = f ? f + "," + e.ctx : e.ctx;
			var g = d.total - d.offset,
				h = b.getOption && b.getOption("chunk_size");
			h = h || b.settings && b.settings.chunk_size, h > g && b.setOption({
				url: "http://upload.qiniu.com/mkblk/" + g
			}), localStorage.setItem(c.name, JSON.stringify({
				ctx: f,
				percent: c.percent,
				total: d.total,
				offset: d.offset,
			...
			return function(d, e, g) {
				...
				if(f = f ? f : i.ctx) {
					...
					if(void 0 !== m && "object" == typeof m)
						for(var p in m) m.hasOwnProperty(p) && ("function" == typeof m[p] ? n = a.URLSafeBase64Encode(m[p](d, e)) : "object" != typeof m[p] && (n = a.URLSafeBase64Encode(m[p])), o += "/x:" + p + "/" + n);
					var q = "http://upload.qiniu.com/mkfile/" + e.size + l + o,
						r = a.createAjax();
